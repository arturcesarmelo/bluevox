   ...
   <div>
      <div class="page-title-with-border ">
         <div class="col-xs-6 col-sm-6 col-md-7">
            <h4> Planos <small class="text-muted"> listagem</small></h4>
         </div>
         ...
         <div class="col-xs-6 col-sm-6 col-md-2 text-right">
            <router-link to="/planos/create" tag="button" class="btn btn-success">
               Cadastrar
            </router-link>
         </div>
      ...
      <div class="page-body">
         <div class="table-content table-responsive" v-if="response.data.length">
            <table class="table table-bordered table-striped table-hover table-condensed">
               ...
               <tbody>
                  <template>
                     <tr v-for="plano in response.data">
                        <th class="col-md-1 text-center">
                           <router-link :to="'/planos/' + plano.id + '/edit' " tag="a" class="btn btn-primary btn-sm">
